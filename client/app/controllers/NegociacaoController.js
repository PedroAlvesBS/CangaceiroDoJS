System.register(['../domain/index.js', '../ui/index.js', '../util/index.js'], function (_export, _context) {
    ...
    var Negociacoes, NegociacaoService, Negociacao, NegociacoesView, MensagemView, Mensagem, DataInvalidaException, DateConverter, getNegociacoesDao, Bind;
    return {
        setters: [function (_domainIndexJs) {
            ...
            getNegociacoesDao = _utilIndexJs.getNegociacoesDao;
        ...
        execute: function () {
            class NegociacaoController {
                ...
                _init() {
                    getNegociacoesDao().then(dao => dao.listaTodos()).then(negociacoes => negociacoes.forEach(negociacao => this._negociacoes.adiciona(negociacao))).catch(err => this._mensagem.texto = err);
                }
                adiciona(event) {
                    try {
                ...
                apaga() {
                    ...
                    getNegociacoesDao().then(dao => dao.apagaTodos()).then(() => {
